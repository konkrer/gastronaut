  ...
  return `
    ...
    >
      ...
      <div class="card-body">
        ...
        <button class="btn btn-sm btn-my-card font-weight-bold mr-2 mr-sm-1 
        mr-md-2 px-3 px-sm-2 px-md--3 brand-outline txt-orange"
        data-toggle="tooltip"
        title="Details"
        ><i class="fas fa-clipboard-list fa-lg"></i></button>
        <button
          class="btn btn-sm btn-my-card font-weight-bold cardMapButton brand-outline
        ...
        <button
          class="btn btn-sm btn-my-card mission-btn font-weight-bold px-3 px-sm-2 px-md--3" 
