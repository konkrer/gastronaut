...
class HelperFunctions:
    ...
    def make_response_add_security_headers(cls, view_html):
        ...
        if not cls.DEBUG:
            ...
            response.headers["Content-Security-Policy"] = "script-src 'self' https://www.googletagmanager.com https://browser.sentry-cdn.com https://kit.fontawesome.com https://cdn.jsdelivr.net https://stackpath.bootstrapcdn.com https://code.jquery.com https://cdn.jsdelivr.net https://apis.google.com https://api.mapbox.com https://unpkg.com https://cdn.rawgit.com https://www.google-analytics.com; worker-src 'self' blob:"  # noqa e501
