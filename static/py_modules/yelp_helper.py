...
yelp_categories = [
    ...
    ('Bangladeshi', 'bangladeshi'), ('Barbeque', 'bbq'), ('Basque', 'basque'),
    ('Brasseries', 'brasseries'), ('Bars', 'bars'), ('Brazilian', 'brazilian'),
    ('Breweries', 'breweries'), ('Breakfast & Brunch', 'breakfast_brunch'),
    ('British', 'british'), ('Bubble Tea', 'bubbletea'),
    ('Buffets', 'buffets'), ('Bulgarian', 'bulgarian'), ('Burgers', 'burgers'),
    ('Burmese', 'burmese'), ('Cafes', 'cafes'), ('Cafeteria', 'cafeteria'),
    ('Cajun/Creole', 'cajun'), ('Cambodian', 'cambodian'),
    ('Caribbean', 'caribbean'), ('Catalan', 'catalan'),
    ('Cheesesteaks', 'cheesesteaks'), ('Chicken Shop', 'chickenshop'),
    ('Chicken Wings', 'chicken_wings'), ('Chinese', 'chinese'),
    ('Cocktail Bars', 'cocktailbars'), ('Coffee & Tea', 'coffee'),
